...
<link rel="stylesheet" type="text/css" href="<?php echo $sg->config->pathto_current_template ?>main.css" />
...
<div id="header"><img src="<?php echo $sg->config->pathto_current_template ?>images/header.gif" alt="<?php echo$sg->config->gallery_name ?>" /></div>
