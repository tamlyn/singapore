...
<div class="sgContainer">
  ...
  <div class="sgContent">
    <table class="sgList">
      ...
      <?php foreach($sg->gallery->galleriesArray() as $index => $gal): ?>
      <tr class="sgRow<?php echo $index%2 ?>">
        <td><a href="<?php echo $sg->formatAdminURL($gal->isAlbum() ? "showimagehits": "showgalleryhits", $$gal->idEncoded())) ?>"><?php echo $gal->name() ?> (<?php echo $gal->idEntities() ?>)</a></td>
