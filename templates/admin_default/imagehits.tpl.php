...
<div class="sgContainer">
  ...
  <div class="sgContent">
    <table class="sgList">
      ...
      <tr>
        <tr class="sgRow<?php echo $index%2 ?>"><td><a href="<?php echo $sg->formatAdminURL("view", $sg->gallery->idEncoded, rawurlencode($img->filename)) ?>"><?php echo $img->name ?> (<?php echo $img->filename ?>)</a></td>
