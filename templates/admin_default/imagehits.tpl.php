...
<div class="sgContainer">
  ...
  <div class="sgContent">
    <table class="sgList">
      ...
      <tr>
        <tr class="sgRow<?php echo $index%2 ?>"><td><a href="<?php echo $sg->formatAdminURL("view", $sg->gallery->getEncodedId(), rawurlencode($img->id)) ?>"><?php echo $img->name ?> (<?php echo $img->id ?>)</a></td>
