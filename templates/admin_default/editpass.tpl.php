<h1><?php echo $sg->_g("change password") ?></h1>
<p><?php echo $sg->_g("Please choose a new password between 6 and 16 characters in length.") ?></p>
...
<table>
<tr>
  <td><?php echo $sg->_g("Current password:") ?></td>
  <td><input type="password" name="sgOldPass" size="23" /></td>
</tr>
<tr>
  <td><?php echo $sg->_g("New password:") ?></td>
  <td><input type="password" name="sgNewPass1" size="23" /></td>
</tr>
<tr>
  <td><?php echo $sg->_g("Confirm password:") ?></td>
